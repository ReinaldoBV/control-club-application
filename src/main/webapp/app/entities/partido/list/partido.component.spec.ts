...
import { sampleWithRequiredData } from '../partido.test-samples';
...
describe('Partido Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, PartidoComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.partidos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to partidoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPartidoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPartidoIdentifier).toHaveBeenCalledWith(entity);
