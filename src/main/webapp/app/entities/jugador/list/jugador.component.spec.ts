...
import { sampleWithRequiredData } from '../jugador.test-samples';
...
describe('Jugador Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, JugadorComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to jugadorService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getJugadorIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getJugadorIdentifier).toHaveBeenCalledWith(entity);
