...
import { sampleWithRequiredData } from '../comuna.test-samples';
...
describe('Comuna Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ComunaComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.comunas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to comunaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getComunaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getComunaIdentifier).toHaveBeenCalledWith(entity);
