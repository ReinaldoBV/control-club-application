...
import { EntityArrayResponseType, CategoriasService } from '../service/categorias.service';
...
export class CategoriasComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICategorias): number => this.categoriasService.getCategoriasIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: ICategorias[] | null): ICategorias[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.categoriasService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
