...
import { sampleWithRequiredData } from '../categorias.test-samples';
...
describe('Categorias Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, CategoriasComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to categoriasService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCategoriasIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCategoriasIdentifier).toHaveBeenCalledWith(entity);
