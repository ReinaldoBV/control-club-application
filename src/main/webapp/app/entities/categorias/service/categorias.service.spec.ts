...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../categorias.test-samples';

import { CategoriasService } from './categorias.service';

const requireRestSample: ICategorias = {
...
describe('Categorias Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Categorias', () => {
      const categorias = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(categorias).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Categorias', () => {
      const categorias = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(categorias).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addCategoriasToCollectionIfMissing', () => {
      it('should add a Categorias to an empty array', () => {
        const categorias: ICategorias = sampleWithRequiredData;
      ...
      it("should add a Categorias to an array that doesn't contain it", () => {
        const categorias: ICategorias = sampleWithRequiredData;
        const categoriasCollection: ICategorias[] = [sampleWithPartialData];
        expectedResult = service.addCategoriasToCollectionIfMissing(categoriasCollection, categorias);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(categorias);
      });
      ...
      it('should add only unique Categorias to an array', () => {
        const categoriasArray: ICategorias[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const categoriasCollection: ICategorias[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const categorias: ICategorias = sampleWithRequiredData;
        const categorias2: ICategorias = sampleWithPartialData;
    ...
    describe('compareCategorias', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareCategorias(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareCategorias(entity1, entity2);
        const compareResult2 = service.compareCategorias(entity2, entity1);
