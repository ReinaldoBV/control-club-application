...
import { EntityArrayResponseType, JugadorService } from '../service/jugador.service';
...
export class JugadorComponent implements OnInit {
  ...
  trackId = (_index: number, item: IJugador): number => this.jugadorService.getJugadorIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.jugadors = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IJugador[] | null): IJugador[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.jugadorService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
